...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        #self.ButtonInsert.MouseClick.connect(self.insertData)
        ...
        animado=AnimatedButton()#incorporación de componente
        lineEdit = animado.lineEdit
        label = QLabel()
        label.setText('Nombre completo:')
        hLayout1 = QVBoxLayout(page1)
        hLayout1.addWidget(label)
        hLayout1.addWidget(animado)
    ...
    def updateData(self):
        try:
            ...
            print('Excepción de actualización')
